...
API_URL  = "https://modernatx.wd1.myworkdayjobs.com/wday/cxs/modernatx/M_tx/jobs"
JOB_BASE = "https://modernatx.wd1.myworkdayjobs.com/en-US/M_tx"
HEADERS  = {
...
async def scrape() -> list[dict]:
    ...
    print(f"[moderna] Done. {len(jobs)} jobs.")
    return jobs
