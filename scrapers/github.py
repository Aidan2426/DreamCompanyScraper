...
JOB_BASE = "https://www.github.careers/careers-home/jobs"
HEADERS  = {
...
async def scrape() -> list[dict]:
    async with AsyncSession(impersonate="chrome124") as session:
        ...
        print(f"[github] total={total}, pages={total_pages}")
    ...
    print(f"[github] Done. {len(jobs)} jobs.")
    return jobs
