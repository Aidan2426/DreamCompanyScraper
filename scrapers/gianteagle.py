...
API_URL  = "https://gianteagle.wd503.myworkdayjobs.com/wday/cxs/gianteagle/GEExternalcareers/jobs"
JOB_BASE = "https://gianteagle.wd503.myworkdayjobs.com/en-US/GEExternalcareers"
HEADERS  = {
...
async def scrape() -> list[dict]:
    async with AsyncSession(impersonate="chrome124") as session:
        ...
        print(f"[gianteagle] total={total}")
    ...
    print(f"[gianteagle] Done. {len(jobs)} jobs.")
    return jobs
