...
JOB_BASE = "https://mastercard.wd1.myworkdayjobs.com/CorporateCareers"
HEADERS  = {
...
async def scrape() -> list[dict]:
    async with AsyncSession(impersonate="chrome124") as session:
        ...
        print(f"[mastercard] total={total}")
    ...
    print(f"[mastercard] Done. {len(jobs)} jobs.")
    return jobs
