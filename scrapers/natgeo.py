...
API_URL  = "https://ngs.wd1.myworkdayjobs.com/wday/cxs/ngs/ngs_external_career_site/jobs"
JOB_BASE = "https://ngs.wd1.myworkdayjobs.com/ngs_external_career_site"
HEADERS  = {
...
async def scrape() -> list[dict]:
    ...
    print(f"[natgeo] Done. {len(jobs)} jobs.")
    return jobs
