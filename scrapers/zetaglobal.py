...
API_URL = "https://boards-api.greenhouse.io/v1/boards/zetaglobal/jobs"
...
async def scrape() -> list[dict]:
    ...
    print(f"[zetaglobal] total={len(raw)}")
    ...
    print(f"[zetaglobal] Done. {len(jobs)} jobs.")
    return jobs
