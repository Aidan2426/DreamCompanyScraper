...
API_URL  = "https://covestro.wd3.myworkdayjobs.com/wday/cxs/covestro/cov_external/jobs"
JOB_BASE = "https://covestro.wd3.myworkdayjobs.com/cov_external"
HEADERS  = {
...
async def scrape() -> list[dict]:
    ...
    print(f"[covestro] Done. {len(jobs)} jobs.")
    return jobs
