...
API_URL  = "https://api.smartrecruiters.com/v1/companies/Sandisk/postings"
JOB_BASE = "https://careers.smartrecruiters.com/Sandisk"
...
async def scrape() -> list[dict]:
    ...
    print(f"[sandisk] Done. {len(jobs)} jobs.")
    return jobs
