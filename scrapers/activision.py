...
LIST_URL = "https://careers.activision.com/search-results"
JOB_BASE = "https://careers.activision.com/job"
HEADERS  = {
...
async def scrape() -> list[dict]:
    async with AsyncSession(impersonate="chrome124") as session:
        ...
        print(f"[activision] total={total}")
    ...
    print(f"[activision] Done. {len(jobs)} jobs.")
    return jobs
