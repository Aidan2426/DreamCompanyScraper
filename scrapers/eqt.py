...
API_URL = "https://boards-api.greenhouse.io/v1/boards/eqtcorporation/jobs?content=true"
...
async def scrape() -> list[dict]:
    ...
    print(f"[eqt] total={len(jobs_raw)}")
    seen = set()
    jobs = []
    for j in jobs_raw:
    ...
    print(f"[eqt] Done. {len(jobs)} jobs.")
    return jobs
