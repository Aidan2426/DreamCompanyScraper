...
API_URL  = "https://viatris.wd5.myworkdayjobs.com/wday/cxs/viatris/External/jobs"
JOB_BASE = "https://viatris.wd5.myworkdayjobs.com/External"
HEADERS  = {
...
async def scrape() -> list[dict]:
    ...
    print(f"[viatris] Done. {len(jobs)} jobs.")
    return jobs
