...
API_URL  = "https://careers.garmin.com/api/jobs"
JOB_BASE = "https://careers.garmin.com/jobs"
HEADERS  = {"Accept": "application/json",
            "Referer": "https://careers.garmin.com/jobs"}
LIMIT       = 100
CONCURRENCY = 5
...
async def scrape() -> list[dict]:
    async with AsyncSession(impersonate="chrome124") as session:
        ...
        print(f"[garmin] total={total}, {total_pages} pages")
    ...
    print(f"[garmin] Done. {len(jobs)} jobs.")
    return jobs
