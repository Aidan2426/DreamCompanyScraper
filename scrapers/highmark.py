...
API_URL  = "https://highmarkhealth.wd1.myworkdayjobs.com/wday/cxs/highmarkhealth/highmark/jobs"
JOB_BASE = "https://highmarkhealth.wd1.myworkdayjobs.com/highmark"
HEADERS  = {
...
async def scrape() -> list[dict]:
    ...
    print(f"[highmark] Done. {len(jobs)} jobs.")
    return jobs
