...
API_URL  = "https://eklm.fa.us2.oraclecloud.com/hcmRestApi/resources/latest/recruitingCEJobRequisitions"
JOB_BASE = "https://eklm.fa.us2.oraclecloud.com/hcmUI/CandidateExperience/en/sites/CX/job"
...
async def scrape() -> list[dict]:
    ...
    print(f"[wesco] Done. {len(jobs)} jobs.")
    return jobs
