...
JOB_BASE = "https://capitalone.wd12.myworkdayjobs.com/Capital_One"
HEADERS  = {
...
async def scrape() -> list[dict]:
    async with AsyncSession(impersonate="chrome124") as session:
        ...
        print(f"[capitalone] total={total}")
    ...
    print(f"[capitalone] Done. {len(jobs)} jobs.")
    return jobs
