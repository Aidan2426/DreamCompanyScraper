...
API_URL  = "https://gevernova.wd5.myworkdayjobs.com/wday/cxs/gevernova/Vernova_ExternalSite/jobs"
JOB_BASE = "https://gevernova.wd5.myworkdayjobs.com/en-US/Vernova_ExternalSite"
HEADERS  = {
...
async def scrape() -> list[dict]:
    ...
    print(f"[gevernova] Done. {len(jobs)} jobs.")
    return jobs
