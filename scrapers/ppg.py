...
API_URL  = "https://ppg.wd5.myworkdayjobs.com/wday/cxs/ppg/PPG_CAREERS/jobs"
JOB_BASE = "https://ppg.wd5.myworkdayjobs.com/en-US/PPG_CAREERS"
HEADERS  = {
...
async def scrape() -> list[dict]:
    ...
    print(f"[ppg] Done. {len(jobs)} jobs.")
    return jobs
