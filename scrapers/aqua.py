...
API_URL  = "https://aquaamerica.wd5.myworkdayjobs.com/wday/cxs/aquaamerica/Essential_Careers/jobs"
JOB_BASE = "https://aquaamerica.wd5.myworkdayjobs.com/Essential_Careers"
HEADERS  = {
...
async def scrape() -> list[dict]:
    ...
    print(f"[aqua] Done. {len(jobs)} jobs.")
    return jobs
