...
API_URL  = "https://jj.wd5.myworkdayjobs.com/wday/cxs/jj/JJ/jobs"
JOB_BASE = "https://jj.wd5.myworkdayjobs.com/en-US/JJ"
HEADERS  = {
...
async def scrape() -> list[dict]:
    ...
    print(f"[jnj] Done. {len(jobs)} jobs.")
    return jobs
