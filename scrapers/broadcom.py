...
JOB_BASE = "https://broadcom.wd1.myworkdayjobs.com/External_Career"
HEADERS  = {
...
async def scrape() -> list[dict]:
    ...
    print(f"[broadcom] Done. {len(jobs)} jobs.")
    return jobs
