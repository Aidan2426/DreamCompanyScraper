...
API_URL  = "https://alcoa.wd5.myworkdayjobs.com/wday/cxs/alcoa/Careers/jobs"
JOB_BASE = "https://alcoa.wd5.myworkdayjobs.com/Careers"
HEADERS  = {
...
async def scrape() -> list[dict]:
    ...
    print(f"[alcoa] Done. {len(jobs)} jobs.")
    return jobs
