...
with httpx.Client(timeout=30, headers=HEADERS, follow_redirects=True) as client:
    r = client.get("https://apply.hp.com/careers?start=0&pid=41194223&sort_by=timestamp")
    print("Status:", r.status_code)
    print("Final URL:", r.url)
    with open("debug_hp.html", "w", encoding="utf-8") as f:
        f.write(r.text)
    ...
    # API hints
    for kw in ["api", "graphql", "jobs", "search", "pid", "start", "taleo", "successfactors", "workday"]:
